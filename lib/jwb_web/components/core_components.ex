defmodule JwbWeb.CoreComponents do
  ...
  def icon(%{name: "kept"} = assigns) do
    ~H"""
    <svg
      class={[@class, "group-hover/link:text-[#C47622]"]}
      width="14"
      height="14"
      fill="none"
      viewBox="0 0 24 24"
  ...
  def icon(%{name: "stfu"} = assigns) do
    ~H"""
    <svg
      class={[@class, "group-hover/link:text-[#4A4AFF]"]}
      width="14"
      height="14"
      fill="none"
      viewBox="0 0 24 24"
  ...
  def icon(%{name: "mmentum"} = assigns) do
    ~H"""
    <svg
      class={[@class, "group-hover/link:text-white"]}
      width="14"
      height="14"
      fill="none"
      viewBox="0 0 16 24"
  ...
  def icon(%{name: "space"} = assigns) do
    ~H"""
    <svg
      class={[@class, "group-hover/link:text-[#03D13E]"]}
      width="14"
      height="14"
      fill="none"
      viewBox="0 0 24 24"
  ...
  def icon(%{name: "flowist"} = assigns) do
    ~H"""
    <svg
      class={[@class, "group-hover/link:text-[#5267F6]"]}
      width="14"
      height="14"
      fill="none"
      viewBox="0 0 24 24"
  ...
  def icon(%{name: "rize"} = assigns) do
    ~H"""
    <svg
      class={[@class, "group-hover/link:text-[#EF2C7C]"]}
      width="14"
      height="14"
      fill="none"
      viewBox="0 0 24 24"
